...
"""autogenerated by genpy from search_and_rescue/Frontier.msg. Do not edit."""
import codecs
import sys
...
class Frontier(genpy.Message):
  _md5sum = "1b8456de71852d4b418f0efe52e743ad"
  _type = "search_and_rescue/Frontier"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Frontier.msg
...
int32 y"""
  __slots__ = ['cells']
  _slot_types = ['search_and_rescue/Cell[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = search_and_rescue.msg.Cell()
        _x = val1
        start = end
        end += 8
