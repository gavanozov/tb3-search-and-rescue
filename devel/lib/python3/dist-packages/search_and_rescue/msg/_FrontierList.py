...
"""autogenerated by genpy from search_and_rescue/FrontierList.msg. Do not edit."""
import codecs
import sys
...
class FrontierList(genpy.Message):
  _md5sum = "d8bff21bf47ea8f3347bdb50aeb48771"
  _type = "search_and_rescue/FrontierList"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# FrontierList.msg
...
int32 y"""
  ...
  _slot_types = ['std_msgs/Header','search_and_rescue/Frontier[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = search_and_rescue.msg.Frontier()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.cells = []
        for i in range(0, length):
          val2 = search_and_rescue.msg.Cell()
          _x = val2
          start = end
          end += 8
