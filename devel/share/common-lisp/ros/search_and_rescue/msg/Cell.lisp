...
(cl:defmethod cl:initialize-instance :after ((m <Cell>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Cell)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name search_and_rescue-msg:<Cell> is deprecated: use search_and_rescue-msg:Cell instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Cell>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader search_and_rescue-msg:x-val is deprecated.  Use search_and_rescue-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Cell>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader search_and_rescue-msg:y-val is deprecated.  Use search_and_rescue-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Cell>)))
  ...
  (cl:format cl:nil "# Cell.msg~%~%int32 x~%int32 y~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Cell)))
  "Returns full string definition for message of type 'Cell"
  (cl:format cl:nil "# Cell.msg~%~%int32 x~%int32 y~%~%"))
